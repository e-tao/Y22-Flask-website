...
-- Dumping data for table bluescafe.menu: ~22 rows (approximately)
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`menuId`, `item`, `entree`, `day`) VALUES
	(52, 'Pizza', 'Tomato Soup', '2022-03-22'),
	(53, 'Jose Special Cookies', 'Latte', '2022-03-23'),
	(54, 'Chicken Sraps', 'Express', '2022-03-24'),
	(55, 'Chef Burgers', 'Coke', '2022-03-25'),
	(56, 'Bagels', 'Iced Coffee', '2022-03-26'),
	(57, 'Donuts', 'Hot Choclate', '2022-03-27');
...
INSERT INTO `user` (`userId`, `username`, `passHash`, `cookieHash`) VALUES
	(1, 'admin', '$2b$12$HHhsTUQRKi6iItqm/.pple4w3dUps.zJnPiJ5iMJ5R9JjDA6uL4C6', '$2b$12$EFjczRoMGStOx7B/RNO9cOA23crmCjfhDTbZeado2nu4xKpLmScCK');
